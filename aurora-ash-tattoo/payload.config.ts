  ...
  globals: [
    {
      ...
      fields: [
        ...
        { name: 'phone', type: 'text', label: 'Phone', defaultValue: '+1 (323) 555-0190' },
        { name: 'email', type: 'text', label: 'Email', defaultValue: 'hello@auroraash.com' },
        {
          name: 'address',
          type: 'textarea',
          localized: true,
          label: 'Address',
          defaultValue: '8282 Santa Monica Blvd\nWest Hollywood, CA 90046',
          admin: { description: 'Single source for visible address across Location, Contact, footer, and schema.' },
        },
        { name: 'addressLocality', type: 'text', label: 'City', defaultValue: 'West Hollywood' },
        { name: 'addressRegion', type: 'text', label: 'State / Region', defaultValue: 'CA' },
        { name: 'postalCode', type: 'text', label: 'Postal Code', defaultValue: '90046' },
        { name: 'addressCountry', type: 'text', label: 'Country Code', defaultValue: 'US' },
        {
          name: 'mapEmbedUrl',
          type: 'text',
          label: 'Map Embed URL',
