  ...
  // =====================================================================
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        accent: true,
        body: [
          { kind: 'h2', text: 'Standards we hold ourselves to' },
          {
            kind: 'ul',
            items: [
              'Every artist is OSHA Bloodborne Pathogen certified.',
              'TFC permit on display, issued by LA County Department of Public Health.',
              'Single-use needles, cartridges, gloves, and ink caps for every session.',
              'No client is tattooed without a signed consent and a valid government-issued ID.',
              'Every published photograph is healed skin (minimum six months after session).',
            ],
          },
        ],
      },
